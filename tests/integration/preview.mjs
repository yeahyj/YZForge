...
export async function preview(code, args = {}) {
  return (await call('execute_javascript', { context: 'editor', args: { code, args }, code: `return await (async()=>{
...
export async function screenshot(fileName) {
  return (await call('execute_javascript', { context: 'editor', args: { fileName }, code: `return await (async()=>{
    ...
    return {path:destination,size:capture.getSize()};})();` })).data;
}

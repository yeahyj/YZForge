...
import type { ConfirmPopupParams, ConfirmPopupResult } from '../ConfirmPopup.types';
const { ccclass, property } = _decorator;
/** 自动绑定基类；由 Creator 根据节点命名写入引用，业务继承后直接使用受保护的节点 getter。 */
@ccclass('showcase.ConfirmPopupBinding')
export class ConfirmPopupBinding extends UIView<ConfirmPopupParams, ConfirmPopupResult> {

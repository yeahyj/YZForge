...
import type { StorageLabPageParams, StorageLabPageResult } from '../StorageLabPage.types';
const { ccclass, property } = _decorator;
/** 自动绑定基类；由 Creator 根据节点命名写入引用，业务继承后直接使用受保护的节点 getter。 */
@ccclass('showcase.StorageLabPageBinding')
export class StorageLabPageBinding extends UIView<StorageLabPageParams, StorageLabPageResult> {
    ...
    /** @internal Creator 自动写入的序列化引用，无需手动拖节点；请勿手改生成字段。 */
    @property({ type: Button, visible: false })
    private _bindBtnSave: Button | null = null;
    /**
     * 自动绑定节点 btn_save 的 Button；节点改名或增删后通过工作台更新绑定。
     * @throws FrameworkError 引用缺失或已失效，需检查命名、组件和绑定结果。
     */
    protected get btnSave(): Button {
        return this.requireBinding(this._bindBtnSave, 'btn_save');
    }
    /** @internal Creator 自动写入的序列化引用，无需手动拖节点；请勿手改生成字段。 */
    @property({ type: Button, visible: false })
    private _bindBtnRead: Button | null = null;
    /**
     * 自动绑定节点 btn_read 的 Button；节点改名或增删后通过工作台更新绑定。
     * @throws FrameworkError 引用缺失或已失效，需检查命名、组件和绑定结果。
     */
    protected get btnRead(): Button {
        return this.requireBinding(this._bindBtnRead, 'btn_read');
    }
    /** @internal Creator 自动写入的序列化引用，无需手动拖节点；请勿手改生成字段。 */
    @property({ type: Button, visible: false })
    private _bindBtnAccount: Button | null = null;
    /**
     * 自动绑定节点 btn_account 的 Button；节点改名或增删后通过工作台更新绑定。
     * @throws FrameworkError 引用缺失或已失效，需检查命名、组件和绑定结果。
     */
    protected get btnAccount(): Button {
        return this.requireBinding(this._bindBtnAccount, 'btn_account');
    }
    /** @internal Creator 自动写入的序列化引用，无需手动拖节点；请勿手改生成字段。 */
    @property({ type: Button, visible: false })
    private _bindBtnBackup: Button | null = null;
    /**
     * 自动绑定节点 btn_backup 的 Button；节点改名或增删后通过工作台更新绑定。
     * @throws FrameworkError 引用缺失或已失效，需检查命名、组件和绑定结果。
     */
    protected get btnBackup(): Button {
        return this.requireBinding(this._bindBtnBackup, 'btn_backup');
    }
    /** @internal Creator 自动写入的序列化引用，无需手动拖节点；请勿手改生成字段。 */
    @property({ type: Button, visible: false })
    private _bindBtnFailure: Button | null = null;
    /**
     * 自动绑定节点 btn_failure 的 Button；节点改名或增删后通过工作台更新绑定。
     * @throws FrameworkError 引用缺失或已失效，需检查命名、组件和绑定结果。
     */
    protected get btnFailure(): Button {
        return this.requireBinding(this._bindBtnFailure, 'btn_failure');
    }
    /** @internal Creator 自动写入的序列化引用，无需手动拖节点；请勿手改生成字段。 */
    @property({ type: Button, visible: false })
    private _bindBtnVersion: Button | null = null;
    /**
     * 自动绑定节点 btn_version 的 Button；节点改名或增删后通过工作台更新绑定。
     * @throws FrameworkError 引用缺失或已失效，需检查命名、组件和绑定结果。
     */
    protected get btnVersion(): Button {
        return this.requireBinding(this._bindBtnVersion, 'btn_version');
    }
    /** @internal Creator 自动写入的序列化引用，无需手动拖节点；请勿手改生成字段。 */
    @property({ type: Button, visible: false })
    private _bindBtnFuture: Button | null = null;
    /**
     * 自动绑定节点 btn_future 的 Button；节点改名或增删后通过工作台更新绑定。
     * @throws FrameworkError 引用缺失或已失效，需检查命名、组件和绑定结果。
     */
    protected get btnFuture(): Button {
        return this.requireBinding(this._bindBtnFuture, 'btn_future');
    }
    /** @internal Creator 自动写入的序列化引用，无需手动拖节点；请勿手改生成字段。 */
    @property({ type: Button, visible: false })
    ...
    protected validateBindings(): void {
        ...
        void this.btnSave;
        void this.btnRead;
        void this.btnAccount;
        void this.btnBackup;
        void this.btnFailure;
        void this.btnVersion;
        void this.btnFuture;
        void this.btnReset;
        void this.lblOutput;

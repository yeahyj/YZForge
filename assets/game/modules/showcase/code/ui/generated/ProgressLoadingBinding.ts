...
import type { ProgressLoadingParams, ProgressLoadingResult } from '../ProgressLoading.types';
const { ccclass, property } = _decorator;
/** 自动绑定基类；由 Creator 根据节点命名写入引用，业务继承后直接使用受保护的节点 getter。 */
@ccclass('showcase.ProgressLoadingBinding')
export class ProgressLoadingBinding extends UIView<ProgressLoadingParams, ProgressLoadingResult> {

...
import type { InspectOverlayParams, InspectOverlayResult } from '../InspectOverlay.types';
const { ccclass, property } = _decorator;
/** 自动绑定基类；由 Creator 根据节点命名写入引用，业务继承后直接使用受保护的节点 getter。 */
@ccclass('showcase.InspectOverlayBinding')
export class InspectOverlayBinding extends UIView<InspectOverlayParams, InspectOverlayResult> {

...
import { ShowcaseModule } from '../public';
 ...
 */
export const createShowcaseModule = defineModule(
    ShowcaseModule,
    { dependencies, services: ShowcaseServices },
    (ctx, _dependencies) => {
        return {
            services: { showcase: new ShowcaseService(ctx) },
            api: {

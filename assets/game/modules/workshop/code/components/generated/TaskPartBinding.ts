...
@ccclass('workshop.TaskPartBinding')
export class TaskPartBinding extends GameComponent {
    ...
    private _bindBtnClaim: Button | null = null;
    /**
     * 自动绑定节点 btn_claim 的 Button；节点改名或增删后通过工作台更新绑定。
     * @throws FrameworkError 引用缺失，需检查命名、组件和绑定结果。
     */

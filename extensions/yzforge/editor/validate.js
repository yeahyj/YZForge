...
const { generatedJson, generatedText, isTextChanged, readJsonc, toPosix, verifyGeneratedHash, verifyGeneratedJsonHash, walk } = require('./fs-utils');
...
function validateGenerated(projectRoot, issues) {
  const generatedFiles = walk(projectRoot, (filePath) => {
    if (/\.generated\.json$/.test(filePath)) {
      return true;
    }
  ...
  for (const filePath of files) {
    ...
    for (const record of importRecords) {
      ...
      const generatedAuthoringImport = record.specifier === 'yzforge/authoring'
        && (content.includes('// <auto-generated>') || rel.endsWith('.generated.ts'));

...
function yzforgePackageScripts() {
  return {
    ...
    'yzforge:update': 'node extensions/yzforge/editor/cli.js update',
    'yzforge:update:check': 'node extensions/yzforge/editor/cli.js update --check',
    'yzforge:config:table': 'node extensions/yzforge/editor/cli.js config-table',
    'yzforge:config:remove': 'node extensions/yzforge/editor/cli.js config-remove',
